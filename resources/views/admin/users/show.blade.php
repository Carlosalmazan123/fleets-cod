    ...
    <div class='flex'>
            ...
            <div class='flex-1 w-full p-8'>
                <h1 class='text-center font-semibold text-2xl'>
                    Informacion del Destino N° {{$users->id}}
                </h1>
                        ...
                        <div class="overflow-hidden">
                          <table class="min-w-full divide-y divide-gray-200 ">
                            ...
                            <tbody class="divide-y divide-gray-200 ">
                                  ...
                                  <tr>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 -200">{{$users->id}}</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 -200">{{$users->name}}</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 -200">{{$users->email}}</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 -200">{{$users->user_type}}</td>
